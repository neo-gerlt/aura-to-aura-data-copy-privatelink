...
| **Aura Data Importer** ([push-to-cloud KB](https://support.neo4j.com/s/article/10932963739539)) | Source dump ≤ 4 GB | Dump > 4 GB |
| **`neo4j-admin database upload`** | Target Aura's public Bolt is reachable; you need `elementId` preservation | Target is PL-only (public Bolt off) |
